...
class ImageLogger:
    ...
    def log_img(self, model, batch, epoch, split="train", foldername=None, returngrid=False, warpeddepth=None, has_target=False, returnimg=False, 
                savegrid=True, onlyretimg=False, **kwargs):
        ...
        if onlyretimg:
            ...
            elif "samples_cfg_scale_5.0" in images:
                imgs = images["samples_cfg_scale_5.0"]
